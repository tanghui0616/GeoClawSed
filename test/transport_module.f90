    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            subroutine crtical_velocity1(mbc,mx,my,h,ub_cr,us_cr1,us_cr2)
            ...
            ! This Part is used to calculate critical velocity for each grain size classes!
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            subroutine crtical_velocity2(mbc,mx,my,h,ubcr,uscr1,uscr2)
                ...
                Real(kind=Prec) :: delta
                !output
                Real(kind=Prec),intent(inout) :: ubcr(1-mbc:mx+mbc,1-mbc:my+mbc,gmax) &
                    , uscr1(1-mbc:mx+mbc,1-mbc:my+mbc,gmax) &
                    , uscr2(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
                ...
                do i = 1-mbc, mx+mbc
                    do j = 1-mbc, my+mbc
                        do k = 1, gmax
                            ...
                            if (D(k) <= 0.0005) then
                                ubcr(i,j,k) = 0.24*(delta*g)**(2.0/3.0)*(D(k)*Trep)**(1.0/3.0)
                            else
                                ubcr(i,j,k) = 0.95*(delta*g)**(0.57)*D(k)**0.43*Trep**0.14
                            end if
            ...
            subroutine sb_vr(mbc,mx,my,u,v,h,Tsg,ceqbg,ceqsg)
                ...
                call crtical_velocity1(mbc,mx,my,h,ub_cr,us_cr1,us_cr2)
            ...
            subroutine vt_vr(mbc,mx,my,u,v,h,Tsg,ceqbg,ceqsg)
                ...
                call crtical_velocity2(mbc,mx,my,h,ub_cr,us_cr1,us_cr2)
            ...
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            subroutine transus(mbc,mx,my,dx,dy,time,u,v,h,dt,cu,cub,cv,cvb,ccg,ccbg,Susg,Subg,Svbg,Svsg)

                use flux, only: Flux_vector,Sus,Svs,Sub,Svb
                ...
                !out
                Real(kind=Prec),intent(inout) :: cu(1-mbc:mx+mbc,1-mbc:my+mbc,gmax),cub(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
                Real(kind=Prec),intent(inout) :: cv(1-mbc:mx+mbc,1-mbc:my+mbc,gmax),cvb(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
                Real(kind=Prec),intent(inout) :: ccg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax),ccbg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
                Real(kind=Prec),intent(inout) :: Susg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax),Subg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
                Real(kind=Prec),intent(inout) :: Svbg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax),Svsg(1-mbc:mx+mbc,1-mbc:my+mbc,gmax)
