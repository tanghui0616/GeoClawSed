        ...
        module bedupdate_module
            ...
            use transport_module, only: vt_vr,sb_vr,transus,cu,cub,cv,cvb,ccg,ccbg,Susg,Subg,Svbg,Svsg,ceqsg,ceqbg,Tsg
            use update
            use sediment_module, only : morstart,morfac,struct,gmax,sourcesink,por,totalthick, & !dzbdt add to sediment_module
                thick,totalnum,toler,nd_var,dzbed,pbbed,trim
            ...
            subroutine bed_update(mbc,mx,my,t,dt,dx,dy,u,v,h,aux,naux)
                ...
                real(kind=Prec), intent(inout) :: aux(naux,1-mbc:mx+mbc,1-mbc:my+mbc),h(1-mbc:mx+mbc,1-mbc:my+mbc)
            ...
            subroutine avalanch(mbc,mx,my,dx,dy,dt,naux,aux,h,t)
                ...
                use sediment_module, only : avalanching,morfac,gmax,hswitch,eps,wetslp,dryslp,totalthick,&
                        dzbed,por,pbbed,nd_var,aval,trim!dzbed,sedcal
